...
SuperImage官方是**一款专业的图像处理软件**。

用于修复老照片和模糊照片的质量问题，具有强大的算法，能够快速有效地还原和修复损坏的照片，并显著提升其图像质量，简单地上传需要修复或增强的照片，在短时间内获得高清晰、高分辨率、高对比度和去噪效果，让照片重新演绎它们的色彩、层次和细节。

### tldraw 

一款开源工具，它能够让你在 React 中创建无限画布体验，简单易用，让每个人都能快速上手，可以个人或者嵌入到产品中。tldraw 的核心功能在于提供无限画布体验，用户可以在这个平台上自由地绘制、编辑和分享。它支持多种形状、文本框、图片以及各种编辑工具，非常适合头脑风暴、教学演示或团队协作。
...
可以免费添加视频，修改变速，添加音频，文字，贴纸，滤镜，特技效果，动态转场。还可以修改比例，设置美颜等多种效果。
...
OBS Studio 是一个强大的录屏和直播推流软件。首先它支持高清录制和高清音频规格，还支持高码率。推流还可以设置多个屏幕，录制软件窗口，也支持相机外置设备。它还有多重混音。

### AutoCut

https://autocut.video/

这是一款正在测试阶段的长期免费自动剪辑工具，支持Windows设备操作，无需注册和登录，大家只需要选择需要剪辑的文件“音频和视频”，然后工具中进行预览、调整编辑后，再导出三步即可完成工作，非常的方便。 

适用于网课、知识区、短视频、直播回放等场景。

AutoCut 可对视频自动生成字幕。用户选择需要保留的句子，AutoCut 将对视频中对应的片段裁切并保存。用户无需使用视频编辑软件，只需要编辑文本文件即可完成剪切。
...
https://www.soundvery.com/

声谷是国内一个免费的白噪音网站，它拥有高品质实录大自然白噪音，可以助眠、减压，还有3D音乐。

白噪声可以通过掩盖破坏性噪音来帮助人们更容易入睡并保持睡眠，它创造了一个一致的听觉环境，这在嘈杂的社区或有睡眠障碍的人特别有用。

此外，对于一些人来说，白噪声可以通过淹没分散注意力的声音来提高注意力和生产力，这在开放式办公室或繁忙的家庭中特别有用。

白噪声还可以起到舒缓作用，减轻压力和焦虑，它通常用于冥想和放松练习。

### 广播迷

**使用地址：**www.guangbomi.com

## 文字转声音

**在线文字转语音**：**texttospeech.im/zh-CN**
